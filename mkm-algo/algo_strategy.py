...
class AlgoStrategy(gamelib.AlgoCore):
    def __init__(self):
        ...
        self.thirdTurrets = []
        self.thirdWalls = [[26,13],[27,13],[11,4],[10,5],[]]
    ...
    def build_defences(self, game_state):
        ...
        if game_state.turn_number == 0:
            game_state.attempt_spawn(FACTORY,self.firstFacories)
            game_state.attempt_upgrade(self.firstFacories)
            ...
            game_state.attempt_spawn(FACTORY, self.secondFacories)
            ...
            game_state.attempt_spawn(self.thirdFactories)
    ...
    def attack(self,game_state):
        if game_state.turn_number <=4:
            ...
            if game_state.turn_number == 3:
                game_state.attempt_spawn(SCOUT, self.firstScouts,100)
